...
void render::initialize() {
	...
	Interfaces::surface->set_font_glyph(render::fonts::watermark_font, "Arial", 13, 500, 0, 0, fontflag_italic);
	Interfaces::surface->set_font_glyph(render::fonts::menu_font, "Consolas", 12, 500, 0, 0, font_flags::fontflag_dropshadow);
	Interfaces::surface->set_font_glyph(render::fonts::esp_font, "Arial", 13, 500, 0, 0, font_flags::fontflag_dropshadow);
}
