...
void menu::render() {
	...
	case 0:
		menu_framework::group_box(variables::menu::x + 110, variables::menu::y + 35, 285, 260, render::fonts::menu_font, "aimbot", false); {
			menu_framework::check_box(variables::menu::x + 120, variables::menu::y + 45, variables::menu::x + 375, render::fonts::menu_font, "Enable Triggerbot", variables::cfg_triggerbot);
			menu_framework::check_box(variables::menu::x + 120, variables::menu::y + 65, variables::menu::x + 375, render::fonts::menu_font, "Enable Triggerbot delay", variables::cfg_trigger_bool_delay_bool);
	...
	case 1:
		menu_framework::group_box(variables::menu::x + 110, variables::menu::y + 35, 285, 260, render::fonts::menu_font, "esp", false); {
			menu_framework::check_box(variables::menu::x + 120, variables::menu::y + 45, variables::menu::x + 375, render::fonts::menu_font, "Enable ESP", variables::cfg_esp);
			menu_framework::check_box(variables::menu::x + 120, variables::menu::y + 70, variables::menu::x + 375, render::fonts::menu_font, "Enable Glow", variables::cfg_glow);
	...
	case 2:
		menu_framework::group_box(variables::menu::x + 110, variables::menu::y + 35, 285, 260, render::fonts::menu_font, "misc", false); {
			menu_framework::check_box(variables::menu::x + 120, variables::menu::y + 45, variables::menu::x + 375, render::fonts::menu_font, "Enable Auto Bunnyhop", variables::cfg_bunnyhop);
			menu_framework::check_box(variables::menu::x + 120, variables::menu::y + 65, variables::menu::x + 375, render::fonts::menu_font, "Enable Watermark", variables::cfg_watermark);
		}
		break;
	}
